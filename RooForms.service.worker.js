...
/** @type {string} */
const CACHE_VERSION = '1787312077|5727175672';
/** @type {string} */
const CACHE_PREFIX = 'RooForms-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'RooForms.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["RooForms.html","RooForms.js","RooForms.offline.html","RooForms.icon.png","RooForms.apple-touch-icon.png","RooForms.audio.worklet.js","RooForms.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["RooForms.wasm","RooForms.pck"];
